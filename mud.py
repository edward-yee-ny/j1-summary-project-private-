class Game:
            ...
            while not game_over:
                ...
                if action == "1": # player attack the enemy
                    ...
                    if player.calculate_dmg(enemy.atk):
                        print("\n", "Game over MegaKnight... Maybe try again next time!")
                        game_over = BATTLE_OUTCOMES["Defeat"], '\n', BATTLE_OUTCOMES["Consolation"]
                        exit(1)
                elif action == "2":
                    player.        
                    while True:
    ...
    # save, load, start new game
    # to load game or save game, have a separate file to save and load from
    # 
    pass